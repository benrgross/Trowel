                      ...
                      <div className="row">
                        ...
                        <div className="col-sm-12 col-md-6 col-lg-6c card-body info">
                          {maxTemp ? (
                            <p>
                              Max Temp:{" "}
                              <span className="data">{maxTemp}F </span>{" "}
                            </p>
                          ) : (
                            ""
                          )}
                          ...
                          {atmosHumidity ? (
                            <p>
                              ...
                              <br></br>
                              <span className="unit-data">
                                Required relative humidity in the air, on a
                                scale from 0 ( less than or equal to 10%) to 10
                          ...
                          {soilHumidity ? (
                            <p>
                              Soil Humidity:{" "}
                              <span className="data">{soilHumidity}</span>{" "}
                              <br></br>
                              <span className="unit-data">
                          ...
                          {soilNutriments ? (
                            <p>
                              ...
                              <br></br>
                              <span className="unit-data">
                                Required quantity of nutriments in the soil, on
                                a scale from 0 (oligotrophic) to 10
                                (hypereutrophic)
                              </span>
                            </p>
                          ) : (
